...
motion = 0; //0.05,
tilt = 0.05,
color = '#add8ec';//#32b3ed'; //#F7931A';//'#FFEED4',
particleSizeBase = 1,
...
linkLengthMin = 0.35, // min linked vertices
...
renderMesh = false,
flicker = true,
flickerSmoothing = 10, // higher = smoother flicker
blurSize = 0,
orbitTilt = true,
randomMotion = true,
noiseLength = 1000,
...
//window.addEventListener('resize', animloop, false);
/**
var btcImage = new Image();
btcImage.src = "https://en.bitcoin.it/w/images/en/2/29/BC_Logo_.png";
btcImage.onload = drawImage();
// https://en.bitcoin.it/w/images/en/2/29/BC_Logo_.png
var ethImage = new Image();
ethImage.src = "https://www.ethereum.org/images/logos/ETHEREUM-ICON_Black_small.png";
ethImage.onload = drawImage();

var btcPattern, ethPattern;
function drawImage(){
//btcPattern = context.createPattern(ethImage, 'repeat')
btcPattern = context.createPattern(btcImage, 'repeat')
}
*/
...
canvas.height = window.innerHeight; //canvas.width * (canvas.clientHeight / canvas.clientWidth);
}
...
context.fillStyle = this.color; //context.createPattern(btcImage, "repeat");
